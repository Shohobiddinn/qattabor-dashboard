            ...
            <UPopover :popper="{ placement: 'bottom-end' }">
              ...
              <template #panel>
                <div class="flex flex-col gap-1 p-2 w-40">
                  <UButton icon="i-heroicons-pencil-square" variant="ghost" @click="openEditModal(article)"
                    class="justify-start">
                    Tahrirlash
                  </UButton>
          ...
          <div class="flex max-sm:flex-wrap gap-2">
            <div class="w-full">
              ...
              <UFormGroup name="region_id" label="Hudud">
                <UInput v-model="form.region_id" type="number" placeholder="Hudud ID" />
              </UFormGroup>
...
function submitForm() {
  console.log('Form yuborildi:', form.value)
  // bu yerda API chaqiruv qilishing mumkin
}
</script>